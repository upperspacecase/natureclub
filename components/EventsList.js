    ...
    <div className="relative" aria-busy={isLoading}>
      ...
      <div className="pointer-events-none absolute inset-y-0 left-0 right-0 z-30 px-6 sm:px-10">
        <button
          ...
          className="btn btn-outline btn-circle pointer-events-auto absolute left-0 top-1/2 h-12 w-12 -translate-y-1/2 bg-base-100/70 text-base-content/80 shadow-lg backdrop-blur-sm active:translate-y-0 active:scale-100"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
        ...
        <button
          ...
          className="btn btn-outline btn-circle pointer-events-auto absolute right-0 top-1/2 h-12 w-12 -translate-y-1/2 bg-base-100/70 text-base-content/80 shadow-lg backdrop-blur-sm active:translate-y-0 active:scale-100"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
